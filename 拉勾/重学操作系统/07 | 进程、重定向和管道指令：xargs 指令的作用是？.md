...
讲师回复： 抱歉，我给错了，试试： find ./ -iname "*.txt" |xargs wc -l
...
讲师回复： 抱歉，我给错了，同学试试： find ./ -iname "*.txt" |xargs wc -l
...
讲师回复： 课程对你偏简单了，你可以考虑自己再查一些资料。这个是应对非OS、运维方向高级研发岗的同学。
...
讲师回复： 刚才man了一下，没找到-i这个选项，只有-iname。具体同学可以再追查下。
