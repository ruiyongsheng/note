...
讲师回复： HTTP/2 支持服务端推送。 websocket 作为一种全双工协议，具有推送功能，它依赖HTTP但不同于HTTP，所以本讲没有介绍。
...
讲师回复： 客户端通过发送ACK报文确认收到，服务端超过时间未收到ACK视为丢包。有兴趣可以查看这篇文章：https://quic-lr-draft-zh.readthedocs.io/zh_CN/latest/An%20Overview%20of%20QUIC%20Loss%20Recovery.html
