...
讲师回复： 出于法律上的考虑，大多以靶场训练为主，结合一些真实案例作为分析
...
讲师回复： 主要从几方面考虑：数据完整性、准确性、时效性，通信安全等方向入手。数据完整性可以加随机数+hash，准确性这个根据业务需求来判断，比较好定，时效性可以加个时间戳、过期时间等方式，通信上可以采用https，但要注意证书校验、openssl漏洞等问题，否则https也可能被中间人攻击。最好的参考案例就是微信支付SDK，可以直接看下他们的文档，金融操作必然要解决这种问题，比如微信付款码重放攻击怎么办，可以多注意下API参数说明：https://pay.weixin.qq.com/wiki/doc/api/micropay.php?chapter=9_10&index=1
...
讲师回复： 留言区留言，或者加入相应的微信学习群，我会统一回复的
