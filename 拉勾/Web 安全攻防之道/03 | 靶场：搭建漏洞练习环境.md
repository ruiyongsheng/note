...
讲师回复： 可以参考这篇文章：https://blog.csdn.net/whatday/article/details/86770609
...
讲师回复： 注意端口映射，不要改到同一个主机端口了，我这边也是就同时运行多个靶场，一个80端口，一个8080端口，参考命令：docker run -d -p 主机端口:容器端口 nginx
