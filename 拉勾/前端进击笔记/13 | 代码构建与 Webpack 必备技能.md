...
讲师回复： 嗯，可以使用 babel loader 提供的能力实现
...
CommonJS 与 ES6 Module 的区别https://kerita.me/04/03/2021/module/
...
讲师回复： Loader 可以做到哦，babel loader 就提供了这样的能力
...
讲师回复： 可以通过 loader 处理的 AST 对象中加上装饰器
...
讲师回复： 实际上，loader 在解析过程中可以拿到 AST，因此也可以对 AST 进行修改，比如 babel 相关的 loader 便会在适当的时候在代码中添加 polyfill。