...
接下来，我带你通过 3 个关键点来用云开发实现后端服务（如果你未开通过云开发，请按照此[指引](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/basis/quickstart.html#_2-开通云开发、创建环境)熟悉并开通）。
...
讲师回复： project.config文件是给微信开发者工具看的，用来调整各项配置，一般在打包时一并打包到dist
...
讲师回复： 可以参考less的webpack部署，网络上有很多资料
...
讲师回复： 测试的APPID由于没有绑定实际主体，所以不能开通云开发，也就无法使用云开发
...
讲师回复： 可以使用less-loader进行处理，具体参考webpack相关指南