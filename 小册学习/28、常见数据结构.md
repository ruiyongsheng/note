...
![](https://user-gold-cdn.xitu.io/2020/5/30/17265c69f5b2f7b9?w=786&h=646&f=png&s=42004)
#### 实现
...
选取了题目[LeetCode 上序号为 20](https://leetcode.com/problems/valid-parentheses/submissions/1)
...
![](https://user-gold-cdn.xitu.io/2020/5/30/17265caaf2c1cf43?w=784&h=610&f=png&s=80377)
...
```
因为单链队列在出队操作的时候需要 O(n) 的时间复杂度，所以引入了`循环队列`。**循环队列的出队操作平均是 O(1) 的时间复杂度。**
...
![](https://user-gold-cdn.xitu.io/2020/5/30/17265cf931fefa70?w=754&h=172&f=png&s=29274)
#### 单向链表
...
![](https://user-gold-cdn.xitu.io/2020/5/30/17265d11eda41d67?w=728&h=590&f=png&s=86077)
#### 二分搜索树
二分搜索树也是二叉树，拥有二叉树的特性。但是区别在于二分搜索树每个节点的值都比他的左子树的值大，比右子树的值小。

这种存储方式很适合于数据搜索。如下图所示，当需要查找 6 的时候，因为需要查找的值比根节点的值大，所以只需要在根节点的右子树上寻找，大大提高了搜索效率。

![](https://user-gold-cdn.xitu.io/2020/5/30/17265d1accbb2f18?w=764&h=666&f=png&s=125103)
...
对于树的遍历来说，有三种遍历方法，分别是`先序遍历`、`中序遍历`、`后序遍历`。三种遍历的区别在于何时访问节点。在遍历树的过程中，每个节点都会遍历三次，分别是遍历到自己，遍历左子树和遍历右子树。如果需要实现先序遍历，那么只需要第一次遍历到节点时进行操作即可。
...
![](https://user-gold-cdn.xitu.io/2020/5/30/17265d7640d6cccd?w=784&h=548&f=png&s=146773)
...
![](https://user-gold-cdn.xitu.io/2020/5/30/17265d9773291f3a?w=774&h=778&f=png&s=154361)
...
![](https://user-gold-cdn.xitu.io/2020/5/30/17265da9ca5e0bfe?w=724&h=366&f=png&s=85051)
...
将根节点最大的堆叫做**最大堆或大根堆**，根节点最小的堆叫做**最小堆**或**小根堆**。
...
![](https://user-gold-cdn.xitu.io/2020/5/30/17265dd0a2af5d88?w=800&h=644&f=png&s=295874)
